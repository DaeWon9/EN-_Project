...
public class LogPanel extends JPanel
{
	...
	public LogPanel()
	{
		...
		ImageIcon imageIcon2 = new ImageIcon(SearchResultPanel.class.getResource("/Image/SearchHistory.png"));		Image image = imageIcon2.getImage().getScaledInstance(235, 50, Image.SCALE_SMOOTH);
		JLabel logLabel = new JLabel(imageIcon2);
		logLabel.setSize(235,50);
		logLabel.setLocation(282,30);
		add(logLabel);
